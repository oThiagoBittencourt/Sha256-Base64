...
# Função para retornar uma string binária de um número decimal
def bin_return(dec):
    return(str(format(dec,'b')))

# Função para retornar uma string binária de um número decimal com 8 bits
def bin_8bit(dec):
    return(str(format(dec,'08b')))

# Função para retornar uma string binária de um número decimal com 32 bits
def bin_32bit(dec):
    return(str(format(dec,'032b')))

# Função para retornar uma string binária de um número decimal com 64 bits
def bin_64bit(dec):
    return(str(format(dec,'064b')))

# Função para retornar uma string hexadecimal de um número decimal
def hex_return(dec):
...
# Função para dividir uma lista em pedaços de tamanho n
def L_P(SET,n):
    to_return=[]
    j=0
    k=n
...
# Função para converter uma string em uma lista de bits
def s_l(bit_string):
    bit_list=[]
...
# Função para converter uma lista de bits em uma string
def l_s(bit_list):
    bit_string=''
...
# Função para fazer uma rotação de bits para a direita
...
# Função para fazer um deslocamento de bits para a direita
...
# Função para realizar uma adição modular de 32 bits
...
# Função para realizar a operação AND entre duas strings binárias
...
# Função para realizar a operação OR entre duas strings binárias
...
# Função para realizar a operação NOT em uma string binária
...
# Função para preenchimento da mensagem
...
# Função para converter uma mensagem em bits
...
# Função para dividir a mensagem em blocos de 32 bits
